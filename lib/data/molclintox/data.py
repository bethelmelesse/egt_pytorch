...
class MOLCLINTOXDataset(DatasetBase):
    def __init__(self, 
                 dataset_path             ,
                 dataset_name = 'MOLCLINTOX' ,
                 **kwargs
                 ):
    ...
    def dataset(self):
        try:
            ...
            self._dataset = GraphPropPredDataset(name='ogbg-molclintox', root=self.dataset_path)
            return self._dataset
...
class MOLCLINTOXGraphDataset(GraphDataset,MOLCLINTOXDataset):
    pass

class MOLCLINTOXSVDGraphDataset(SVDEncodingsGraphDataset,MOLCLINTOXDataset):
    pass

class MOLCLINTOXStructuralGraphDataset(StructuralDataset,MOLCLINTOXGraphDataset):
    pass

class MOLCLINTOXStructuralSVDGraphDataset(StructuralDataset,MOLCLINTOXSVDGraphDataset):
    pass
