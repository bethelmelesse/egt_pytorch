...
class MOLTOXCASTDataset(DatasetBase):
    def __init__(self, 
                 dataset_path             ,
    ...
    def dataset(self):
        try:
            ...
            self._dataset = GraphPropPredDataset(name='ogbg-moltoxcast', root=self.dataset_path)
            return self._dataset
...
class MOLTOXCASTGraphDataset(GraphDataset,MOLTOXCASTDataset):
    pass

class MOLTOXCASTSVDGraphDataset(SVDEncodingsGraphDataset,MOLTOXCASTDataset):
    pass

class MOLTOXCASTStructuralGraphDataset(StructuralDataset,MOLTOXCASTGraphDataset):
    pass

class MOLTOXCASTStructuralSVDGraphDataset(StructuralDataset,MOLTOXCASTSVDGraphDataset):
    pass
