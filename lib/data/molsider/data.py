...
class MOLSIDERDataset(DatasetBase):
    def __init__(self, 
                 dataset_path             ,
                 dataset_name = 'MOLSIDER' ,
                 **kwargs
                 ):
    ...
    def dataset(self):
        try:
            ...
            self._dataset = GraphPropPredDataset(name='ogbg-molsider', root=self.dataset_path)
            return self._dataset
...
class MOLSIDERGraphDataset(GraphDataset,MOLSIDERDataset):
    pass

class MOLSIDERSVDGraphDataset(SVDEncodingsGraphDataset,MOLSIDERDataset):
    pass

class MOLSIDERStructuralGraphDataset(StructuralDataset,MOLSIDERGraphDataset):
    pass

class MOLSIDERStructuralSVDGraphDataset(StructuralDataset,MOLSIDERSVDGraphDataset):
    pass
