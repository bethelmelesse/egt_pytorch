...
class MOLBACEDataset(DatasetBase):
    def __init__(self, 
                 dataset_path             ,
                 dataset_name = 'MOLBACE' ,
                 **kwargs
                 ):
    ...
    def dataset(self):
        try:
            ...
            self._dataset = GraphPropPredDataset(name='ogbg-molbace', root=self.dataset_path)
            return self._dataset
...
class MOLBACEGraphDataset(GraphDataset,MOLBACEDataset):
    pass

class MOLBACESVDGraphDataset(SVDEncodingsGraphDataset,MOLBACEDataset):
    pass

class MOLBACEStructuralGraphDataset(StructuralDataset,MOLBACEGraphDataset):
    pass

class MOLBACEStructuralSVDGraphDataset(StructuralDataset,MOLBACESVDGraphDataset):
    pass
