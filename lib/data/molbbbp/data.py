...
class MOLBBBPDataset(DatasetBase):
    def __init__(self, 
                 dataset_path             ,
    ...
    def dataset(self):
        try:
            ...
            self._dataset = GraphPropPredDataset(name='ogbg-molbbbp', root=self.dataset_path)
            return self._dataset
...
class MOLBBBPGraphDataset(GraphDataset,MOLBBBPDataset):
    pass

class MOLBBBPSVDGraphDataset(SVDEncodingsGraphDataset,MOLBBBPDataset):
    pass

class MOLBBBPStructuralGraphDataset(StructuralDataset,MOLBBBPGraphDataset):
    pass

class MOLBBBPStructuralSVDGraphDataset(StructuralDataset,MOLBBBPSVDGraphDataset):
    pass
