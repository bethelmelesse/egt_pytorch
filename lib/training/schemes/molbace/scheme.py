...
from lib.models.molbace import EGT_MOLBACE
from lib.data.molbace import MOLBACEStructuralSVDGraphDataset

class MOLBACE_Training(EGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name    = 'molbace',
            dataset_path    = 'cache_data/MOLBACE',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, MOLBACEStructuralSVDGraphDataset
    
    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config, EGT_MOLBACE
