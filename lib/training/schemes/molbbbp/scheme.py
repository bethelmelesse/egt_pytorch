...
from lib.models.molbbbp import EGT_MOLBBBP
from lib.data.molbbbp import MOLBBBPStructuralSVDGraphDataset

class MOLBBBP_Training(EGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name    = 'molbbbp',
            dataset_path    = 'cache_data/MOLBBBP',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, MOLBBBPStructuralSVDGraphDataset
    
    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config, EGT_MOLBBBP
