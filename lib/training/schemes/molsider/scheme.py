...
from lib.models.molsider import EGT_MOLSIDER
from lib.data.molsider import MOLSIDERStructuralSVDGraphDataset

class MOLSIDER_Training(EGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name    = 'molsider',
            dataset_path    = 'cache_data/MOLSIDER',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, MOLSIDERStructuralSVDGraphDataset
    
    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config, EGT_MOLSIDER
