...
from lib.models.molclintox import EGT_MOLCLINTOX
from lib.data.molclintox import MOLCLINTOXStructuralSVDGraphDataset

class MOLCLINTOX_Training(EGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name    = 'molclintox',
            dataset_path    = 'cache_data/MOLCLINTOX',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, MOLCLINTOXStructuralSVDGraphDataset
    
    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config, EGT_MOLCLINTOX
